Rails.application.routes.draw do
  ...
  root to: "main#index_search_notebooks"
  ...
  post "add_search_result_to_search_notebook", to: "main#add_search_result_to_search_notebook", as: "add_search_result_to_search_notebook"
end
